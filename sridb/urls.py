...
from sridb.views import (
    ...
    SRIAssessorViewSet, SRIServiceCatalogueViewSet,
    ...
    SRICyberDeviceDataViewSet, SRIEnergyDataViewSet, 
    SRIOperationalDataViewSet, SRIOutdoorenvironmentalDataViewSet, 
    SRIOnsiteenergygenerationViewSet,
    SRIIctequipmentViewSet,
    SRIDataSourceViewSet,
    SRICommunicationProtocolViewSet,
    SRIInterfaceViewSet,
    SRIModelViewSet,
    SRIInformationNeedViewSet,
    SRIUtilityGridDataViewSet,
    SRIInformationNeedDataViewSet,
    SRIDeviceViewSet,
    SRIDataConnectorViewSet,
    SRISupportedAccessViewSet
)

# must add SRIMethodologyViewSet, if put in database layer
# must add SRIUsecaseViewSet, if put in database layer
...
router.register(r'sri-information-need', SRIInformationNeedViewSet)
router.register(r'sri-utility-grid-data', SRIUtilityGridDataViewSet)
router.register(r'sri-information-need-data', SRIInformationNeedDataViewSet)

# ICT routes
router.register(r'sri-ict-equipment', SRIIctequipmentViewSet)
router.register(r'sri-data-source', SRIDataSourceViewSet)
router.register(r'sri-communication-protocol', SRICommunicationProtocolViewSet)
router.register(r'sri-interface', SRIInterfaceViewSet)
router.register(r'sri-model', SRIModelViewSet)
router.register(r'sri-device', SRIDeviceViewSet)
router.register(r'sri-data-connector', SRIDataConnectorViewSet)
router.register(r'sri-supported-access', SRISupportedAccessViewSet)
